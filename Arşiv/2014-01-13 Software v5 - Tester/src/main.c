...
#pragma config IESO   = ON//ON
#pragma config PWRTEN = OFF//OFF
#pragma config BOREN  = OFF
#pragma config BORV   = 19
#pragma config WDTEN  = ON
#pragma config WDTPS  = 4     //1 second weak-up
#pragma config MCLRE  = ON
#pragma config HFOFST = ON//ON
...
volatile unsigned char cTestCounter1 = 0;
volatile unsigned short long iTestResult = 0;
...
//    vBeep( PASS );
    ...
    vOpenI2C();
    ClrWdt();
    iTestResult = cEEReadByte(0);
    iTestResult <<= 8;
    ClrWdt();
    iTestResult |= cEEReadByte(1);
    iTestResult <<= 8;
    ClrWdt();
    iTestResult |= cEEReadByte(2);
    ClrWdt();
    vCloseI2C();
    ...
    while(1)
    {
        ...
        if(cTestCounter1 == 250)
        {
            ...
            vOpenI2C();
            ClrWdt();
            vEEWriteByte(0,(iTestResult >> 16) & 0x0000FF);
             ClrWdt();
            vEEWriteByte(1,(iTestResult >> 8) & 0x0000FF);
             ClrWdt();
            vEEWriteByte(2,(iTestResult ) & 0x0000FF);
            ClrWdt();            
            vCloseI2C();
        }
//        Sleep();
