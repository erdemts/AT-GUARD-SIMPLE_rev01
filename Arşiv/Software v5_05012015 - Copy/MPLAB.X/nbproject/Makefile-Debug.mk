...
${OBJECTDIR}/_ext/1360937237/RF125KHz.o: ../src/RF125KHz.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -p$(MP_PROCESSOR_OPTION) -I".." -I"../include" -I"../src" -I"../../Microchip/Include" -I"../../Microchip/USB" -ms --extended -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1360937237/RF125KHz.o   ../src/RF125KHz.c 
...
${OBJECTDIR}/_ext/1360937237/RF125KHz.o: ../src/RF125KHz.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360937237/RF125KHz.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/RF125KHz.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -I".." -I"../include" -I"../src" -I"../../Microchip/Include" -I"../../Microchip/USB" -ms --extended -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1360937237/RF125KHz.o   ../src/RF125KHz.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1360937237/RF125KHz.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/RF125KHz.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
